...
const e_2 = `const c_2 = <div id="cr-2" className="code-result"> /* function call */
    <div>                           /* function call */ 
...
render( c_2, document.getElementById( "cr-2" ) ); /* Injection to DOM */`;

const c_2 = <div id="cr-2" className="code-result">
    <div>
        <h1>this is h1 tag</h1>
    </div>
    <div>
